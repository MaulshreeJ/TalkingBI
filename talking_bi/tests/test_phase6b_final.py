...
try:
    ...
    print("[OK] Intent model imports successfully")
    print("  Valid intents:", sorted(VALID_INTENTS))
    assert "TOP_N" not in VALID_INTENTS
    print("[OK] TOP_N correctly removed")
...
print("[OK] Intent parser fallback behavior: PASS")
...
if missing:
    ...
    print("[OK] Intent structure: PASS")
...
if stored["run_id"] == "abc-123":
    print(
        "[OK] Deep copy protection: PASS (original mutation did not affect stored state)"
    )
else:
...
print("  [OK] Intent taxonomy correct (TOP_N removed)")
print("  [OK] Intent parser runtime behavior (fallbacks work)")
print("  [OK] Case-insensitive KPI validation")
print("  [OK] Intent structure complete")
print("  [OK] Deep copy protection verified")
print("  [OK] Intent persistence in code")
print()
